    ...
    for smi in smiles:
        try:
            ...
            g = mol_to_bigraph(mol, add_self_loop=True,
                               ...
                               canonical_atom_order=False).to(args['device'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('-fi', '--file', type=str, default='data/DrugCombDB/drug_smiles.tsv',
    ...
    parser.add_argument('-o', '--out-dir', type=str, default='./Data/DrugCombDB',
